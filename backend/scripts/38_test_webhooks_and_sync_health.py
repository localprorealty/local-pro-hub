...
def test_schema_status():
    ...
    try:
        ...
        print(f"  ✗ bm_webhook_events_log table NOT YET CREATED: {e}")
    ...
    try:
        ...
        print(f"  ✗ bm_sync_log.triggered_by column NOT YET CREATED: {e}")
    ...
    try:
        ...
        print(f"  ✗ bm_transactions.deleted_at column NOT YET CREATED: {e}")
...
if __name__ == "__main__":
    ...
    test_schema_status()
    print("\n==================================================")
    print("ALL CODE LOGIC TESTS PASSED!")
    print("==================================================")
