            ...
            <div className="mx-auto w-full max-w-xl">
              ...
              <form className="space-y-4" onSubmit={handleForgotSubmit} noValidate>
                <div className="space-y-1.5">
                  <Label htmlFor="email" className="text-[14px] font-medium text-[var(--color-text-secondary)]">
                    Email address
                  </Label>
                  <Input
                    id="email"
              ...
              <div className="mt-8 text-left">
                <button
                  ...
                  className="group inline-flex items-center gap-1 text-[14px] text-[var(--color-text-secondary)] transition-colors hover:text-[var(--color-gold)]"
                >
                  Back to Sign in
                </button>
              </div>
      ...
      <div className="relative z-10 min-h-0 flex-1 overflow-y-auto">
        ...
        >
          ...
          <form className="space-y-4" onSubmit={handleSubmit} noValidate>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <Label htmlFor="password" className="text-[14px] font-medium text-[var(--color-text-secondary)]">
                  Password
                </Label>
                <button
                  type="button"
                  ...
                  disabled={isLoading}
                  className="text-xs text-[var(--color-text-secondary)] hover:text-[var(--color-gold)] transition-colors disabled:opacity-50"
                >
                  Forgot password?
                </button>
              </div>
          ...
          <div className="mt-8 text-left">
            ...
            >
              New to LP Hub?{' '}
              <span className="font-semibold text-[var(--color-text)] group-hover:text-[var(--color-gold)]">
                Request access
